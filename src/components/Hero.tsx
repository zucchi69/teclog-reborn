...
export const Hero = () => {
  return (
    <section
      id="inicio"
      className="scroll-mt-24 relative min-h-screen flex items-start overflow-hidden"
    >
      {/* Background */}
      <div className="absolute inset-0">
        <img
          ...
          className="w-full h-full object-cover object-[center_95%] scale-125"
        />
      ...
      <div className="container mx-auto px-4 relative z-10 pt-10 pb-12">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 backdrop-blur-sm border border-gold/30 rounded-full px-5 py-2 mb-6 animate-fade-up opacity-0 bg-gold">
            ...
            <span className="font-medium text-petrol-dark">
              Referência em Engenharia de Dutos
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl max-w-2xl mb-8 animate-fade-up opacity-0 animation-delay-200 text-primary-foreground">
            Há mais de 30 anos oferecendo soluções especializadas em limpeza,
            inertização e manutenção de dutos para a indústria de petróleo e gás
            do Brasil.
          </p>
