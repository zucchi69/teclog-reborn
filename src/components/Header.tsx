    ...
    <>
      ...
      <div className="bg-petrol-dark text-primary-foreground py-2 hidden md:block">
        <div className="container mx-auto px-4 flex justify-between items-center text-sm">
          ...
          <span className="text-gold-light font-medium">+30 anos de excelência em engenharia</span>
        </div>
      </div>
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={`px-4 py-2 font-medium transition-all duration-300 rounded-lg ${
                  isScrolled 
                    ? "text-foreground hover:text-petrol hover:bg-muted" 
                    : "text-primary-foreground/90 hover:text-gold-light hover:bg-primary-foreground/10"
                }`}
              >
                {link.label}
              </a>
